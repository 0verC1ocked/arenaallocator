...
PROTOBUF_NAMESPACE_OPEN
template<> ::IPC::IPCMessage* Arena::CreateMaybeMessage<::IPC::IPCMessage>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace IPC {
...
class IPCMessage PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:IPC.IPCMessage) */ {
 public:
  ...
  void set_type(::IPC::IPCMessageType value);
  private:
  ::IPC::IPCMessageType _internal_type() const;
  void _internal_set_type(::IPC::IPCMessageType value);
  public:
...
inline ::IPC::IPCMessageType IPCMessage::_internal_type() const {
  return static_cast< ::IPC::IPCMessageType >(type_);
}
inline ::IPC::IPCMessageType IPCMessage::type() const {
  // @@protoc_insertion_point(field_get:IPC.IPCMessage.type)
  return _internal_type();
}
inline void IPCMessage::_internal_set_type(::IPC::IPCMessageType value) {
  
  type_ = value;
}
inline void IPCMessage::set_type(::IPC::IPCMessageType value) {
...
template <> struct is_proto_enum< ::IPC::IPCMessageType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::IPC::IPCMessageType>() {
  return ::IPC::IPCMessageType_descriptor();
}
